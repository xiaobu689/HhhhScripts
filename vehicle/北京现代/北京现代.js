...
let _0x268653 = ["\n"],
    env_name = "BJXD",
    _0x219a02 = (_0x8716db.isNode() ? process.env[env_name] : _0x8716db.getdata(env_name)) || "",
    _0x2d9559 = [],
    _0x2c43fb = 0,
    _0x1b86b6 = 0,
...
class _0x4c27a8 {
    ...
    async getUserInfo() {
        ...
        try {
            ...
            _0x2c6f90.fn = "getUserInfo";
            _0x2c6f90.method = "get";
            _0x2c6f90.url = "https://bm2-api.bluemembers.com.cn/v1/app/account/users/info";
    ...
    async getScore() {
        ...
        try {
            ...
            _0x58462f.fn = "getScore";
            _0x58462f.method = "get";
            _0x58462f.url = "https://bm2-api.bluemembers.com.cn/v1/app/account/users/info";
    ...
    async reward_list() {
        ...
        try {
            ...
            if (typeof _0x3f6116?.["result"] === "object") {
                ...
                if (_0x56041.code == 0) {
                    let hid = _0x56041.data.hid
                    let rewardHash = _0x56041.data.rewardHash
                    for (let item of _0x56041.data.list) {
                        if (item.hid === hid) {
                            score = item.score;
                            console.log('tip: 如果签到成功, 积分+' + score);
                        }
                    }
                    await this.reward_report(hid, rewardHash)
                } else {
    ...
    async reward_report(hid, rewardHash) {
        let _0x46c394 = {};
        try {
            const _0x34c67b = {
                hid: hid,
            ...
            _0x492fab.fn = "reward_report";
            _0x492fab.method = "post";
            _0x492fab.url = "https://bm2-api.bluemembers.com.cn/v1/app/user/reward_report";
            _0x492fab.body = _0x34c67b;
    ...
    async taskList() {
        ...
        try {
            ...
            _0xa3d25c.fn = "taskList";
            _0xa3d25c.method = "get";
            _0xa3d25c.url = "https://bm2-api.bluemembers.com.cn/v1/app/user/task/list";
            ...
            if (typeof _0x8f513e?.["result"] === "object") {
                ...
                if (_0x5469c5.code == 0) {
                    if (_0x5469c5.data.state == 1) {
                        console.log("开始答题：");
                        let question = _0x5469c5.data.question_info.content
                        let choices = "";
                        console.log(question);
                        for (let _0x296803 of _0x5469c5.data.question_info.option) {
                            let choice = _0x296803.option + ": " + _0x296803.option_content
                            choices += choice + "\n";
                            console.log(choice);
                        }
                        let questionWithChoices = question + "\n" + choices;
                        await this.ask_answer(questionWithChoices);
                    } else {
                        console.log("今日已完成答题");
                    }
                } else {
    ...
    async ask_answer(question) {
        let _0x320116 = {};
        let answer = ''
        let _0x16af4f = _0x8716db.randomList(question.option);
        try {
            getGPTResponse(question).then(content => {
                console.log("通义千问回答: ", content);
                if (content === 'A' || content === 'B' || content === 'C' || content === 'D') {
                    answer = content
                } else {
                    console.log("通义千问状态异常，切换为盲答");
                    answer = _0x16af4f
            ...
            const _0x5c6056 = {
                answer: answer,
                questions_hid: question.questions_hid
            };
            const _0x17ec0d = {
                fn: "ask_answer"
            };
            _0x17ec0d.fn = "ask_answer";
            _0x17ec0d.method = "post";
            _0x17ec0d.url = "https://bm2-api.bluemembers.com.cn/v1/app/special/daily/ask_answer";
            _0x17ec0d.body = _0x5c6056;
    ...
    if ($request.url.includes("v1/app/white/lovecar/banner")) {
        try {
            ...
            if (!_0x219a02?.["includes"](_0x13b4b6)) {
                ...
                _0x8716db.setdata(_0x219a02, env_name);
                _0x8716db.msg("获取第" + _0x1b71ef.length + "个账户CK成功，保存到变量[" + env_name + "]: " + _0x13b4b6);
            }
        } catch (_0x4cf3b5) { }
    }
}
...
async function _0x521f1c(_0x263b8f, _0x513b4c) {
    return new Promise(_0x40a2b3 => {
        _0x8716db.send(_0x263b8f, _0x513b4c, async (_0x6e577d, _0x129293, _0xf085c6) => {
            ...
            _0x348782.err = _0x6e577d;
            _0x348782.req = _0x129293;
            _0x348782.resp = _0xf085c6;
            _0x40a2b3(_0x348782);
        });
    });
}
    ...
    return new class {
        ...
        send(_0x30ed81, _0x46cad7, _0x1cc856 = () => { }) {
            ...
            if (this.isSurge() || this.isLoon()) {
                ...
                _0x3a24fc.method = _0x30ed81;
                _0x3a24fc.url = _0x46cad7.url;
                _0x3a24fc.headers = _0x46cad7.headers;
                _0x3a24fc.timeout = _0x46cad7.timeout;
                _0x3a24fc.data = _0x46cad7.body;
            ...
            const _0x3c126f = _0xf16ff0 => {
                ...
                if ("object" == typeof _0xf16ff0) {
                    if (this.isLoon()) {
                        ...
                        _0x5d7302.openUrl = _0x2fda6e;
                        _0x5d7302.mediaUrl = _0x1bd995;
                        return _0x5d7302;
                    }
                    if (this.isQuanX()) {
