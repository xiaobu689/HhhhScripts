...
mallHeaders = {
    ...
    'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148  Rmt/PuTuo; Version/5.0.1',
...
def total_score():
    json_data = {}
    url = 'https://ptapi.shmedia.tech/media-basic-port/api/app/personal/score/total'
...
def can_change_gift():
    ...
    params = {
        ...
        'page_no': '1',
        'page_size': '50',
        'shop_cat_id': '1433697221967314945',
        'sort': 'create_desc',
    }
